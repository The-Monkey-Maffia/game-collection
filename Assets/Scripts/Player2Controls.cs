...
//     version 1.4.4
//     from Assets/Scripts/Player2Controls.inputactions
//
...
public partial class @Player2Controls : IInputActionCollection2, IDisposable
{
    ...
    public struct MovementActions
    {
        ...
        public MovementActions(@Player2Controls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Player2Controls m_Wrapper;
        public ShootingActions(@Player2Controls wrapper) { m_Wrapper = wrapper; }
